...
class Huffman {
    ...
    public static final class Node {
        ...
        public Node() {
            this.a = new Node[UserVerificationMethods.USER_VERIFY_HANDPRINT];
            this.b = 0;
            this.c = 0;
        }
