...
public class AlertDialogLayout extends QG {
        ...
        if (mode2 != 1073741824) {
            ...
            for (int i12 = 0; i12 < childCount; i12++) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (((LinearLayout.LayoutParams) pg).width == -1) {
                        int i13 = ((LinearLayout.LayoutParams) pg).height;
                        ((LinearLayout.LayoutParams) pg).height = childAt3.getMeasuredHeight();
                        measureChildWithMargins(childAt3, makeMeasureSpec2, 0, i2, 0);
                        ((LinearLayout.LayoutParams) pg).height = i13;
                    }
                }
            }
        }
