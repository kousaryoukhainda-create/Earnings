...
public final class ActionMode$CallbackC1874j60 implements ActionMode.Callback {
    ...
    public ActionMode$CallbackC1874j60(ActionMode.Callback callback, TextView textView) {
        this.a = callback;
        this.b = textView;
    }
