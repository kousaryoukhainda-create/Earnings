...
public final class S0 {
    ...
    public S0(AccessibilityNodeInfo accessibilityNodeInfo, int i) {
    ...
    public final CharSequence g() {
        ...
        if (!isEmpty) {
            ...
            for (int i = 0; i < c2.size(); i++) {
                spannableString.setSpan(new D0(((Integer) c5.get(i)).intValue(), this, accessibilityNodeInfo.getExtras().getInt("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_ACTION_ID_KEY")), ((Integer) c2.get(i)).intValue(), ((Integer) c3.get(i)).intValue(), ((Integer) c4.get(i)).intValue());
            }
    ...
    public final void i(R0 r0) {
        this.a.setCollectionItemInfo(r0.a);
    }
    ...
    public final String toString() {
        ...
        int i = Build.VERSION.SDK_INT;
        if (i >= 34) {
            Q0.b(accessibilityNodeInfo, rect);
        } else {
        ...
        if (i >= 30) {
            charSequence = M0.b(accessibilityNodeInfo);
        } else {
        ...
        sb.append("; uniqueId: ");
        if (i >= 33) {
            string = N0.g(accessibilityNodeInfo);
        } else {
        ...
        if (i >= 34) {
            charSequence3 = Q0.c(accessibilityNodeInfo);
        } else {
        ...
        if (actionList != null) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                emptyList.add(new L0(actionList.get(i2), 0, null, null, null));
            }
        } else {
            emptyList = Collections.emptyList();
        }
        for (int i3 = 0; i3 < emptyList.size(); i3++) {
            L0 l0 = (L0) emptyList.get(i3);
            String d = d(l0.a());
