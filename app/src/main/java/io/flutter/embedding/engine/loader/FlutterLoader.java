...
public class FlutterLoader {
    ...
    private String fullAssetPathFrom(@NonNull String str) {
        ...
        return AbstractC0324Hi.h(sb, File.separator, str);
    }
    ...
    public /* synthetic */ void lambda$ensureInitializationCompleteAsync$1(Context context, String[] strArr, Handler handler, Runnable runnable) {
        try {
            ...
            HandlerCompat.createAsyncHandler(Looper.getMainLooper()).post(new RunnableC0417Kx(this, context, strArr, handler, runnable, 1));
        } catch (Exception e) {
    ...
    public void ensureInitializationComplete(@NonNull Context context, String[] strArr) {
    ...
    public void ensureInitializationCompleteAsync(@NonNull Context context, String[] strArr, @NonNull Handler handler, @NonNull Runnable runnable) {
        if (Looper.myLooper() == Looper.getMainLooper()) {
            if (this.settings != null) {
                if (this.initialized) {
                    handler.post(runnable);
                    ...
                    this.executorService.execute(new RunnableC0417Kx(this, context, strArr, handler, runnable, 0));
                    return;
                }
            }
            throw new IllegalStateException("ensureInitializationComplete must be called after startInitialization");
    ...
    public String getLookupKeyForAsset(@NonNull String str, @NonNull String str2) {
        ...
        return getLookupKeyForAsset(AbstractC2437ph.m(sb, str3, str2, str3, str));
    }
