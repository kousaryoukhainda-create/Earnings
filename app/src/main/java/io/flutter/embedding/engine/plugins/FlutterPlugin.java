...
public interface FlutterPlugin {
    ...
    public static class FlutterPluginBinding {
        ...
        public FlutterPluginBinding(@NonNull Context context, @NonNull FlutterEngine flutterEngine, @NonNull BinaryMessenger binaryMessenger, @NonNull TextureRegistry textureRegistry, @NonNull PlatformViewRegistry platformViewRegistry, @NonNull FlutterAssets flutterAssets, FlutterEngineGroup flutterEngineGroup) {
