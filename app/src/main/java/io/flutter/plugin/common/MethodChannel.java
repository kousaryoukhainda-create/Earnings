...
public class MethodChannel {
    ...
    public void invokeMethod(@NonNull String str, Object obj, Result result) {
    ...
    public MethodChannel(@NonNull BinaryMessenger binaryMessenger, @NonNull String str, @NonNull MethodCodec methodCodec, BinaryMessenger.TaskQueue taskQueue) {
