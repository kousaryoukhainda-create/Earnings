...
public class PlatformPlugin {
    ...
    public void popSystemNavigator() {
        ...
        if (activity instanceof UP) {
            ((UP) activity).getOnBackPressedDispatcher().b();
        } else {
            activity.finish();
        }
    }
    ...
    public void setSystemChromeApplicationSwitcherDescription(PlatformChannel.AppSwitcherDescription appSwitcherDescription) {
        ...
        this.activity.setTaskDescription(AQ.d(appSwitcherDescription.color, appSwitcherDescription.label));
    }
    ...
    public PlatformPlugin(@NonNull Activity activity, @NonNull PlatformChannel platformChannel, PlatformPluginDelegate platformPluginDelegate) {
