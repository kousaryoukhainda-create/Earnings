...
public class ListenableEditingState extends SpannableStringBuilder {
    ...
    public ListenableEditingState(TextInputChannel.TextEditState textEditState, @NonNull View view) {
    ...
    public void endBatchEdit() {
        ...
        if (i == 1) {
            ...
            if (!this.mListeners.isEmpty()) {
                ...
                notifyListenersIfNeeded(equals, z, (this.mComposingStartWhenBeginBatchEdit == getComposingStart() && this.mComposingEndWhenBeginBatchEdit == getComposingEnd()) ? true : true);
            }
        }
