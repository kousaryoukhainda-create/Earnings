...
public abstract class yf {
    ...
    public static a b(byte[] bArr, int i, int i2) {
        bh bhVar = new bh(bArr, i, i2);
        bhVar.d(8);
        int f = bhVar.f();
        int f2 = bhVar.f();
        bhVar.g();
        return new a(f, f2, bhVar.c());
    }
    ...
    */
    public static com.applovin.impl.yf.b c(byte[] r22, int r23, int r24) {
        /*
            Method dump skipped, instructions count: 363
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.applovin.impl.yf.c(byte[], int, int):com.applovin.impl.yf$b");
    }
    ...
    private static void a(bh bhVar, int i) {
        ...
        for (int i4 = 0; i4 < i; i4++) {
            if (i2 != 0) {
                i2 = ((bhVar.e() + i3) + UserVerificationMethods.USER_VERIFY_HANDPRINT) % UserVerificationMethods.USER_VERIFY_HANDPRINT;
            }
            if (i2 != 0) {
                i3 = i2;
            }
