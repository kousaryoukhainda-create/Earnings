...
public class AppLovinStarRatingView extends View {
    ...
    private void drawFilledStars(Canvas canvas, Path path) {
        ...
        double ceil = Math.ceil(roundUpToNearestHalfInt - 1.0f) * this.interStarsSpacingDp;
        canvas.clipPath(path);
        canvas.drawRect(new RectF(0.0f, 0.0f, ((roundUpToNearestHalfInt / 5.0f) * 5.0f * this.sideLength) + ((float) (ceil + this.paddingDp)), getHeight()), filledStarPaint);
    }
