...
public class NotificationDetails implements Serializable {
    ...
    @WZ(alternate = {"allowWhileIdle"}, value = SCHEDULE_MODE)
    ...
    private static ArrayList<MessageDetails> readMessages(ArrayList<Map<String, Object>> arrayList) {
        ...
        if (arrayList != null) {
            ...
            while (it.hasNext()) {
                ...
                arrayList2.add(new MessageDetails((String) next.get(TEXT), Wh0.Q(next.get("timestamp")), readPersonDetails((Map) next.get(PERSON)), (String) next.get(DATA_MIME_TYPE), (String) next.get(DATA_URI)));
            }
        }
        return arrayList2;
    }
    ...
    private static void readPlatformSpecifics(Map<String, Object> map, NotificationDetails notificationDetails) {
        ...
        if (map2 != null) {
            ...
            notificationDetails.when = Wh0.Q(map2.get(WHEN));
            ...
            notificationDetails.timeoutAfter = Wh0.Q(map2.get(TIMEOUT_AFTER));
