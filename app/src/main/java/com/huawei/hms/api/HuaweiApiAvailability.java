...
public abstract class HuaweiApiAvailability {
    ...
    static {
        ...
        AbstractC0324Hi.y(hashMap, HMS_API_NAME_GAME, 20503000, HMS_VERSION_CODE_OD, HMS_API_NAME_OD);
    ...
    public abstract L50 checkApiAccessible(HuaweiApi<?> huaweiApi, HuaweiApi<?>... huaweiApiArr);

    public abstract L50 checkApiAccessible(HuaweiApiCallable huaweiApiCallable, HuaweiApiCallable... huaweiApiCallableArr);
    ...
    public abstract L50 getHuaweiServicesReady(Activity activity);
