...
public class IapFailureTask<T extends Result> extends L50 {
    private int a;
    private String b;
    ...
    public L50 addOnFailureListener(InterfaceC0846aQ interfaceC0846aQ) {
        ...
        interfaceC0846aQ.onFailure(new IapApiException(new Status(this.a, this.b)));
        return this;
    }
    ...
    public T m18getResult() {
        return null;
    }

    /* renamed from: getResultThrowException */
    public <E extends Throwable> T m19getResultThrowException(Class<E> cls) throws Throwable {
        return null;
    }
