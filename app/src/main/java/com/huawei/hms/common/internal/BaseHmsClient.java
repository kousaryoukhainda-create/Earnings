...
public abstract class BaseHmsClient implements AidlApiClient {
    ...
    public void disconnect() {
        ...
        AbstractC0324Hi.s(i2, "Enter disconnect, Connection Status: ", "BaseHmsClient");
        if (i2 != 3) {
            if (i2 == 5) {
                b();
                b(1);
    ...
    private void a(int i2, boolean z) {
        ...
        AbstractC0324Hi.s(i3, "Enter connect, Connection Status: ", "BaseHmsClient");
        if (z || !(i3 == 3 || i3 == 5)) {
            if (getMinApkVersion() > i2) {
                i2 = getMinApkVersion();
            }
            StringBuilder i4 = AbstractC0324Hi.i(i2, "connect minVersion:", " packageName:");
            i4.append(this.c.getInnerHmsPkg());
            HMSLog.i("BaseHmsClient", i4.toString());
            if (this.a.getPackageName().equals(this.c.getInnerHmsPkg())) {
                ...
                AbstractC0324Hi.s(isHuaweiMobileServicesAvailable, "check available result: ", "BaseHmsClient");
                ...
                AbstractC0324Hi.s(isHuaweiMobileServicesAvailable2, "HuaweiApiAvailability check available result: ", "BaseHmsClient");
