...
public class HMSPackageManager {
    ...
    public class b implements Runnable {
        ...
        public void run() {
            ...
            try {
                List<ResolveInfo> queryIntentServices = HMSPackageManager.this.a.getPackageManager().queryIntentServices(new Intent("com.huawei.hms.core.aidlservice"), UserVerificationMethods.USER_VERIFY_PATTERN);
    ...
    private Pair<String, String> g() {
        try {
            List<ResolveInfo> queryIntentServices = this.a.getPackageManager().queryIntentServices(new Intent("com.huawei.hms.core.aidlservice"), UserVerificationMethods.USER_VERIFY_PATTERN);
            if (queryIntentServices != null && queryIntentServices.size() != 0) {
    ...
    private Pair<String, String> h() {
        ...
        while (it.hasNext()) {
            ...
            if (a(str + ContainerUtils.FIELD_DELIMITER + packageSignature + ContainerUtils.FIELD_DELIMITER + str2, str3, str4)) {
                StringBuilder q2 = BK.q("result: ", str, ", ", str2, ", ");
                q2.append(next.f);
                HMSLog.i("HMSPackageManager", q2.toString());
    ...
    private ArrayList<PackagePriorityInfo> i() {
        try {
            List<ResolveInfo> queryIntentServices = this.a.getPackageManager().queryIntentServices(new Intent(PackageConstants.GENERAL_SERVICES_ACTION), UserVerificationMethods.USER_VERIFY_PATTERN);
                        ...
                        if (TextUtils.isEmpty(a3)) {
                            ...
                            if (TextUtils.isEmpty(a4)) {
                                ...
                                if (TextUtils.isEmpty(a5)) {
                                    ...
                                    StringBuilder q2 = BK.q("add: ", str, ", ", a2, ", ");
                                    q2.append(packageFirstInstallTime);
                                    HMSLog.i("HMSPackageManager", q2.toString());
    ...
    public PackageManagerHelper.PackageStates getHMSPackageStates() {
        synchronized (p) {
            try {
                ...
                } else if (packageStates == PackageManagerHelper.PackageStates.ENABLED && !c(this.c, this.d)) {
                    return packageStates2;
                } else {
        ...
        synchronized (p) {
            try {
                ...
                if (packageStates == packageStates2) {
                    ...
                    return PackageManagerHelper.PackageStates.SPOOF;
                } else if (packageStates == PackageManagerHelper.PackageStates.ENABLED && !c(this.f, this.g)) {
                    return packageStates2;
                } else {
                    return packageStates;
                }
    ...
    public boolean isUpdateHmsForThirdPartyDevice() {
        if ("com.huawei.hwid".equals(this.f) && AgHmsUpdateState.getInstance().isUpdateHms()) {
            return true;
        }
        return false;
    }
    ...
    private Pair<String, String> a(Bundle bundle, String str, String str2, String str3) {
        ...
        if (!bundle.containsKey(str4)) {
            ...
            if (!a(AbstractC0324Hi.g(str, ContainerUtils.FIELD_DELIMITER, str3), bundle.getString(str4), bundle.getString("hms_app_cert_chain"))) {
