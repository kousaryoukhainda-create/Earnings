...
public final class p9 extends n9<Placement> {
    ...
    @NotNull
    public final i9<p9> e;
    @NotNull
    public final AdDisplay f;
    public Placement g;

    public p9(@NotNull v9 hyprMXWrapper, @NotNull SettableFuture fetchFuture, @NotNull String placementName, @NotNull ExecutorService uiThreadExecutorService, @NotNull AdDisplay adDisplay) {
        r9 adsCache = r9.a;
    ...
    public static final void a(p9 this$0) {
        ...
        placement.setPlacementListener(s9.a);
        placement.loadAd();
