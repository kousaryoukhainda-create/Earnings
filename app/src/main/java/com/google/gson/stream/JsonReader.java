...
public class JsonReader implements Closeable {
    ...
    static {
        CF.INSTANCE = new CF() { // from class: com.google.gson.stream.JsonReader.1
            @Override // defpackage.CF
            public void promoteNameToValue(JsonReader jsonReader) throws IOException {
                if (jsonReader instanceof EF) {
                    EF ef = (EF) jsonReader;
                    ef.getClass();
                    ef.a(JsonToken.NAME);
                    Map.Entry entry = (Map.Entry) ((Iterator) ef.c()).next();
                    ef.f(entry.getValue());
                    ef.f(new AF((String) entry.getKey()));
                    return;
                }
    ...
    */
    ...
    public String locationString() {
        StringBuilder n = AbstractC2437ph.n(" at line ", this.lineNumber + 1, " column ", (this.pos - this.lineStart) + 1, " path ");
        n.append(getPath());
        return n.toString();
    }
