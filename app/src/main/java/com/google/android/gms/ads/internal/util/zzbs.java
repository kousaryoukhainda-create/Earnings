...
public final class zzbs {
                ...
                if (opt instanceof Boolean) {
                    ...
                    if (jSONArray.length() != 0) {
                        ...
                        if (obj == null) {
                            ...
                            com.google.android.gms.ads.internal.util.client.zzo.zzj("JSONArray with unsupported type " + obj.getClass().getCanonicalName() + " for key:" + next);
                        }
                    }
    ...
    public static String zzm(zzfbt zzfbtVar) {
        if (zzfbtVar == null) {
            return null;
        }
