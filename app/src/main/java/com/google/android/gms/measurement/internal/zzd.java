...
public final class zzd extends zzf {
    ...
    /* JADX WARN: Type inference failed for: r1v1, types: [java.util.Map, Z10] */
    /* JADX WARN: Type inference failed for: r1v2, types: [java.util.Map, Z10] */
    ...
    public final void zza(String str, long j) {
        if (str != null && str.length() != 0) {
            ...
            AbstractC0324Hi.u(this.zzu, "Ad unit id must be a non-empty string");
        }
    }
    ...
    public final /* synthetic */ void zzd(String str, long j) {
        ...
        if (num != null) {
            ...
            AbstractC0324Hi.z(this.zzu, "Too many ads visible");
        } else {
            map.put(str, 1);
    ...
    public final /* synthetic */ void zze(String str, long j) {
        ...
        if (num != null) {
            ...
            if (intValue == 0) {
                ...
                if (l == null) {
                    AbstractC0324Hi.u(this.zzu, "First ad unit exposure time was never set");
                } else {
                    map2.remove(str);
                ...
                if (map.isEmpty()) {
                    long j2 = this.zzc;
                    if (j2 == 0) {
                        AbstractC0324Hi.u(this.zzu, "First ad exposure time was never set");
                        return;
                    }
                    zzh(j - j2, zzh);
                    this.zzc = 0L;
