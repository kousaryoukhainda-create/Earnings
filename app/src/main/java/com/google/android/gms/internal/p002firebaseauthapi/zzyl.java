...
public final class zzyl implements zzzu {
    ...
    public zzyl(byte[] bArr, int i) throws GeneralSecurityException {
        if (zza.zza()) {
    ...
    public final byte[] zzb(byte[] bArr) throws GeneralSecurityException {
        ...
        throw new GeneralSecurityException(AbstractC0324Hi.e(Integer.MAX_VALUE - this.zzd, "plaintext length can not exceed "));
    }
