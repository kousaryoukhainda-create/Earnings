...
final class zzcj {
    ...
    private final void zzk() {
        ...
        int i11 = 0;
        int i12 = 1;
        int i13 = (d > 1.00001d ? 1 : (d == 1.00001d ? 0 : -1));
        int i14 = this.zzm;
        if (i13 <= 0 && d >= 0.99999d) {
            ...
            if (i15 >= this.zzh) {
                ...
                while (true) {
                    ...
                    if (i17 > 0) {
                        ...
                        if (this.zzb == i12 && i == i12) {
                            i2 = zzg(sArr, i16, this.zzf, this.zzg);
                        } else {
                            zzi(sArr, i16, i);
                            int zzg = zzg(this.zzi, i11, this.zzf / i, this.zzg / i);
                            if (i != i12) {
                                int i19 = zzg * i;
                                int i20 = i * 4;
                                int i21 = this.zzf;
        ...
        if (f != 1.0f && this.zzm != i14) {
            ...
            int i34 = this.zzm - i14;
            short[] zzl3 = zzl(this.zzn, this.zzo, i34);
            this.zzn = zzl3;
            short[] sArr5 = this.zzl;
            int i35 = this.zzb;
            System.arraycopy(sArr5, i14 * i35, zzl3, this.zzo * i35, i35 * i34);
            this.zzm = i14;
            this.zzo += i34;
            int i36 = 0;
            while (true) {
                ...
                while (true) {
                    ...
                    while (true) {
                        ...
                        if (i37 < i38) {
                            ...
                            long j9 = j7 - j5;
                            sArr6[i39 + i37] = (short) ((((j8 - j9) * s2) + (j9 * s)) / j8);
                            i37++;
                            i36 = i36;
                            j3 = j6;
                            j4 = j4;
            ...
            if (i8 != 0) {
                ...
                int i42 = this.zzb;
                System.arraycopy(sArr8, i8 * i42, sArr8, 0, (i7 - i8) * i42);
                this.zzo -= i8;
            }
        }
    }
