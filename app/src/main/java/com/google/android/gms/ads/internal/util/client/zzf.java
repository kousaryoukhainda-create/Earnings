...
public final class zzf {
    ...
    private static final void zzD(ViewGroup viewGroup, com.google.android.gms.ads.internal.client.zzs zzsVar, String str, int i, int i2) {
    ...
    public static final void zzw(Context context, String str, String str2, Bundle bundle, boolean z, zze zzeVar) {
        ...
        Uri.Builder appendQueryParameter = new Uri.Builder().scheme(HttpConnection.DEFAULT_SCHEME).path("//pagead2.googlesyndication.com/pagead/gen_204").appendQueryParameter("id", "gmob-apps");
    ...
    public final void zzl(ViewGroup viewGroup, com.google.android.gms.ads.internal.client.zzs zzsVar, String str, String str2) {
        if (str2 != null) {
            zzo.zzj(str2);
        }
        zzD(viewGroup, zzsVar, str, -65536, -16777216);
    }

    public final void zzm(ViewGroup viewGroup, com.google.android.gms.ads.internal.client.zzs zzsVar, String str) {
        zzD(viewGroup, zzsVar, "Ads by Google", -16777216, -1);
    }
