...
public final class zzcbg extends FrameLayout implements zzcax {
    ...
    private final void zzJ() {
        if (this.zzb.zzi() != null && this.zzi && !this.zzj) {
            this.zzb.zzi().getWindow().clearFlags(UserVerificationMethods.USER_VERIFY_PATTERN);
            this.zzi = false;
        }
    }
    ...
    public final void zzF(int i, int i2, int i3, int i4) {
        if (com.google.android.gms.ads.internal.util.zze.zzc()) {
            StringBuilder n = AbstractC2437ph.n("Set video bounds to x:", i, ";y:", i2, ";w:");
            n.append(i3);
            n.append(";h:");
            n.append(i4);
    ...
    public final void zze() {
        ...
        if (this.zzb.zzi() != null && !this.zzi) {
            if ((this.zzb.zzi().getWindow().getAttributes().flags & UserVerificationMethods.USER_VERIFY_PATTERN) != 0) {
                z = true;
            } else {
                z = false;
            }
            this.zzj = z;
            if (!z) {
                this.zzb.zzi().getWindow().addFlags(UserVerificationMethods.USER_VERIFY_PATTERN);
                this.zzi = true;
            }
        }
        this.zzh = true;
    ...
    public final void zzf() {
        ...
        if (zzcayVar != null && this.zzm == 0) {
            ...
            zzK("canplaythrough", UserSessionStorage.DURATION, String.valueOf(zzcayVar.zzc() / 1000.0f), "videoWidth", String.valueOf(zzcayVar2.zze()), "videoHeight", String.valueOf(zzcayVar2.zzd()));
        }
    }
        ...
        if (zzcayVar != null) {
            ...
            if (this.zzl != zza && zza > 0) {
                ...
                if (((Boolean) com.google.android.gms.ads.internal.client.zzbe.zzc().zza(zzbcl.zzbY)).booleanValue()) {
                    ...
                    zzK("timeupdate", CrashHianalyticsData.TIME, String.valueOf(f));
                }
                this.zzl = zza;
            }
        }
