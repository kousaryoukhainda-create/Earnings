...
public final class zzfkr {
    ...
    private zzfkr(zzflc zzflcVar, WebView webView, String str, List list, String str2, String str3, zzfks zzfksVar) {
        this.zza = zzflcVar;
        this.zzb = webView;
        this.zzg = zzfksVar;
        this.zzf = str2;
    ...
    public static zzfkr zzb(zzflc zzflcVar, WebView webView, String str, String str2) {
        if (str2 != null) {
            zzfmk.zzd(str2, UserVerificationMethods.USER_VERIFY_HANDPRINT, "CustomReferenceData is greater than 256 characters");
        }
    ...
    public static zzfkr zzc(zzflc zzflcVar, WebView webView, String str, String str2) {
        zzfmk.zzd("", UserVerificationMethods.USER_VERIFY_HANDPRINT, "CustomReferenceData is greater than 256 characters");
