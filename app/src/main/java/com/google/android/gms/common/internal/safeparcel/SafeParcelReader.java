...
public class SafeParcelReader {
    ...
    public static void ensureAtEnd(@NonNull Parcel parcel, int i) {
        ...
        throw new ParseException(AbstractC0324Hi.e(i, "Overread allowed size end="), parcel);
    }
    ...
    public static int validateObjectHeader(@NonNull Parcel parcel) {
        ...
        if (fieldId == 20293) {
            ...
            throw new ParseException(AbstractC0324Hi.d(dataPosition, i, "Size read is invalid start=", " end="), parcel);
        }
    ...
    private static void zza(Parcel parcel, int i, int i2, int i3) {
        ...
        throw new ParseException(AbstractC0324Hi.h(AbstractC2437ph.n("Expected size ", i3, " got ", i2, " (0x"), Integer.toHexString(i2), ")"), parcel);
    }
    ...
    private static void zzb(Parcel parcel, int i, int i2) {
        ...
        throw new ParseException(AbstractC0324Hi.h(AbstractC2437ph.n("Expected size ", i2, " got ", readSize, " (0x"), Integer.toHexString(readSize), ")"), parcel);
    }
}
