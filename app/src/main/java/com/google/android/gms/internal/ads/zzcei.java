...
final class zzcei extends zzfr implements zzgt {
    ...
    public final HttpURLConnection zzk(long j, long j2, int i) throws zzgp {
        ...
        try {
            ...
            httpURLConnection.setRequestProperty(HttpConnection.USER_AGENT_HEADER, this.zzd);
            httpURLConnection.setRequestProperty(HttpConnection.ACCEPT_ENCODING, "identity");
