...
public abstract class FastJsonResponse {
    ...
    private final void zaE(Field field, Object obj) {
        ...
        switch (i) {
            ...
            case 3:
            default:
                throw new IllegalStateException(AbstractC0324Hi.e(i, "Unsupported type for conversion: "));
            case 4:
                if (zae != null) {
    ...
    public static class Field<I, O> extends AbstractSafeParcelable {
        ...
        public Field(int i, boolean z, int i2, boolean z2, @NonNull String str, int i3, Class cls, FieldConverter fieldConverter) {
            this.zai = 1;
            this.zaa = i;
            this.zab = z;
            this.zac = i2;
