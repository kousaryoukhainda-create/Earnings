...
public final class zzapi {
    ...
    private zzapi(int i, byte[] bArr, Map map, List list, boolean z, long j) {
        this.zza = i;
        this.zzb = bArr;
        this.zzc = map;
    ...
    @Deprecated
    public zzapi(int i, byte[] bArr, Map map, boolean z, long j) {
    ...
    */
    public zzapi(int r9, byte[] r10, boolean r11, long r12, java.util.List r14) {
        /*
            r8 = this;
            if (r14 != 0) goto L5
            r0 = 0
