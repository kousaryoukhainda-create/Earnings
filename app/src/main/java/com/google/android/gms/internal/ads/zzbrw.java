...
public final class zzbrw implements MediationInterstitialAdapter {
    ...
    public final void showInterstitial() {
        C0507Ok a = new C0481Nk().a();
        Uri uri = this.zzc;
        Intent intent = a.a;
        intent.setData(uri);
        com.google.android.gms.ads.internal.util.zzs.zza.post(new zzbrv(this, new AdOverlayInfoParcel(new com.google.android.gms.ads.internal.overlay.zzc(intent, null), null, new zzbru(this), null, new VersionInfoParcel(0, 0, false), null, null, "")));
