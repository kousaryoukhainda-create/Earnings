...
public final class zzyv extends zztn implements RandomAccess, zzyd, zzzo {
    ...
    public final /* bridge */ /* synthetic */ zzyd zzd(int i) {
        if (i >= this.zzc) {
            return new zzyv(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
    ...
    private zzyv(long[] jArr, int i, boolean z) {
        super(z);
        this.zzb = jArr;
        this.zzc = i;
    }
