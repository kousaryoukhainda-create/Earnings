...
public final class zzab {
    ...
    public final int hashCode() {
        ...
        if (i == 0) {
            ...
            int floatToIntBits = Float.floatToIntBits(this.zzx);
            int floatToIntBits2 = Float.floatToIntBits(this.zzz);
            int i7 = this.zzK + ((((((((((((((((((((floatToIntBits2 + ((((floatToIntBits + ((((((((((i6 + i2) * 31) + this.zzp) * 31) + ((int) this.zzt)) * 31) + this.zzv) * 31) + this.zzw) * 31)) * 31) + this.zzy) * 31)) * 31) + this.zzB) * 31) + this.zzD) * 31) + this.zzE) * 31) + this.zzF) * 31) + this.zzG) * 31) + this.zzH) * 31) + this.zzI) * 31) - 1) * 31) - 1) * 31);
            this.zzM = i7;
            return i7;
        }
        return i;
