...
public final class zzs extends zzbz {
    ...
    private static final C1243e5 zzb;
    ...
    /* JADX WARN: Type inference failed for: r0v1, types: [e5, Z10] */
    static {
        ?? z10 = new Z10();
        zzb = z10;
        z10.put("registered", FastJsonResponse.Field.forStrings("registered", 2));
        z10.put("in_progress", FastJsonResponse.Field.forStrings("in_progress", 3));
        z10.put("success", FastJsonResponse.Field.forStrings("success", 4));
        z10.put("failed", FastJsonResponse.Field.forStrings("failed", 5));
        z10.put("escrowed", FastJsonResponse.Field.forStrings("escrowed", 6));
    }
    ...
    public final Object getFieldValue(FastJsonResponse.Field field) {
        switch (field.getSafeParcelableFieldId()) {
            ...
            case 6:
                return this.zzg;
            default:
                throw new IllegalStateException(AbstractC0324Hi.e(field.getSafeParcelableFieldId(), "Unknown SafeParcelable id="));
        }
    }
