...
public final class zzdy {
    ...
    private final int zzP(Charset charset) {
        ...
        if (charset.equals(StandardCharsets.UTF_8) || charset.equals(StandardCharsets.US_ASCII)) {
            ...
            int i3 = this.zze;
            if (i2 - i3 > 0) {
                zza2 = (byte) zzgan.zza(this.zzd[i3] & 255);
                return (zzgan.zza(zza2) << 16) + i;
            }
        }
        if (charset.equals(StandardCharsets.UTF_16) || charset.equals(StandardCharsets.UTF_16BE)) {
            ...
            if (i4 - i5 >= 2) {
                byte[] bArr = this.zzd;
                zzb2 = zzgan.zzb(bArr[i5], bArr[i5 + 1]);
                zza2 = (byte) zzb2;
                i = 2;
                return (zzgan.zza(zza2) << 16) + i;
            }
        ...
        if (charset.equals(StandardCharsets.UTF_16LE)) {
            ...
            if (i6 - i7 >= 2) {
                byte[] bArr2 = this.zzd;
                zzb2 = zzgan.zzb(bArr2[i7 + 1], bArr2[i7]);
                zza2 = (byte) zzb2;
                i = 2;
                return (zzgan.zza(zza2) << 16) + i;
            }
    ...
    public final int zzj() {
        ...
        throw new IllegalStateException(AbstractC0324Hi.e(zzi, "Top bit not zero: "));
    }
    ...
    public final int zzp() {
        ...
        throw new IllegalStateException(AbstractC0324Hi.e(zzg, "Top bit not zero: "));
    }
    ...
    public final long zzr() {
        ...
        this.zze = i3 + 8;
        long j6 = j5 & 255;
        return ((bArr[i2] & 255) << 56) | ((bArr[i] & 255) << 48) | ((j & 255) << 8) | (bArr[i3] & 255) | ((j2 & 255) << 16) | ((j3 & 255) << 24) | ((j4 & 255) << 32) | (j6 << 40);
    }
    ...
    public final long zzt() {
        ...
        this.zze = i3 + 7;
        this.zze = i3 + 8;
        return (bArr[i2] & 255) | ((bArr[i3] & 255) << 56) | ((j & 255) << 48) | ((j2 & 255) << 40) | ((j3 & 255) << 32) | ((j4 & 255) << 24) | ((j5 & 255) << 16) | ((bArr[i] & 255) << 8);
    }
    ...
    public final long zzw() {
        ...
        throw new IllegalStateException(BK.l(zzt, "Top bit not zero: "));
    }
