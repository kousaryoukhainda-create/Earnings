...
public final class zac {
    private static final Z10 zaa = new Z10();
        ...
        synchronized (z10) {
            try {
                ...
                if (Build.VERSION.SDK_INT >= 24) {
                    a = new C1975kI(new C2319oI(AbstractC0400Kg.a(configuration)));
                } else {
                    a = C1975kI.a(configuration.locale);
                }
                Locale locale = a.a.get();
                if (!locale.equals(zab)) {
                    z10.clear();
                    zab = locale;
                }
                String str2 = (String) z10.getOrDefault(str, null);
                if (str2 != null) {
                    return str2;
                }
