...
public final class zaaa extends Button {
    ...
    private static final int zab(int i, int i2, int i3, int i4) {
        if (i != 0) {
            if (i != 1) {
                ...
                throw new IllegalStateException(AbstractC0324Hi.e(i, "Unknown color scheme: "));
            }
            return i3;
        }
        return i2;
    ...
    public final void zaa(Resources resources, int i, int i2) {
        ...
        if (i != 0 && i != 1) {
            if (i != 2) {
                throw new IllegalStateException(AbstractC0324Hi.e(i, "Unknown button size: "));
            }
        } else {
            zab = zab2;
        }
        Drawable g0 = AbstractC2870uj.g0(resources.getDrawable(zab));
        AbstractC0746Xp.h(g0, resources.getColorStateList(R.color.common_google_signin_btn_tint));
        AbstractC0746Xp.i(g0, PorterDuff.Mode.SRC_ATOP);
        setBackgroundDrawable(g0);
