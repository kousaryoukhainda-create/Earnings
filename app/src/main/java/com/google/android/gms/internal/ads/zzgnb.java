...
public final class zzgnb {
    ...
    public final Class zza(Class cls) throws GeneralSecurityException {
        ...
        throw new GeneralSecurityException(AbstractC2437ph.h("No input primitive class for ", cls.toString(), " available"));
    }
    ...
    public final Object zzb(zzgdx zzgdxVar, Class cls) throws GeneralSecurityException {
        ...
        throw new GeneralSecurityException(AbstractC2437ph.h("No PrimitiveConstructor for ", zzgmzVar.toString(), " available"));
    }
