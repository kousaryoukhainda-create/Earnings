        ...
        try {
            try {
                ...
                if (MediationAdapter.class.isAssignableFrom(cls)) {
                    return new zzbqf((MediationAdapter) cls.getDeclaredConstructor(null).newInstance(null));
                }
                if (Adapter.class.isAssignableFrom(cls)) {
                    return new zzbqf((Adapter) cls.getDeclaredConstructor(null).newInstance(null));
                }
