...
public final class zzfbz {
    ...
    public zzfbz(JsonReader jsonReader, zzbvk zzbvkVar) throws IllegalStateException, IOException, JSONException, NumberFormatException, AssertionError {
        Bundle bundle;
        Bundle bundle2;
        this.zzd = zzbvkVar;
        if (((Boolean) com.google.android.gms.ads.internal.client.zzbe.zzc().zza(zzbcl.zzck)).booleanValue() && zzbvkVar != null && (bundle2 = zzbvkVar.zzm) != null) {
            Kh0.k(bundle2, zzdre.SERVER_RESPONSE_PARSE_START.zza());
        }
