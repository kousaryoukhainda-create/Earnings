...
interface zzaof {
    ...
    void zza(int i, zzajp zzajpVar) throws IOException;

    <K, V> void zza(int i, zzalx<K, V> zzalxVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    @Deprecated
    void zza(int i, Object obj, zzamv zzamvVar) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<zzajp> list) throws IOException;

    @Deprecated
    void zza(int i, List<?> list, zzamv zzamvVar) throws IOException;
    ...
    void zzb(int i, Object obj, zzamv zzamvVar) throws IOException;

    void zzb(int i, List<String> list) throws IOException;

    void zzb(int i, List<?> list, zzamv zzamvVar) throws IOException;
