...
final class zzaks {
    ...
    public static /* bridge */ /* synthetic */ void zzb(zzaks zzaksVar, zzdy zzdyVar, int i) {
        ...
        if (i >= 4) {
            zzdyVar.zzM(3);
            int i2 = i - 4;
            if ((zzdyVar.zzm() & UserVerificationMethods.USER_VERIFY_PATTERN) != 0) {
    ...
    public static /* bridge */ /* synthetic */ void zzd(zzaks zzaksVar, zzdy zzdyVar, int i) {
        ...
        while (i4 < i3) {
            ...
            double d2 = zzm3 - 128;
            double d3 = zzm4 - 128;
            zzaksVar.zzb[zzm] = Math.max(0, Math.min((int) ((d3 * 1.772d) + d), 255)) | (zzdyVar.zzm() << 24) | (Math.max(i2, Math.min((int) ((1.402d * d2) + d), 255)) << 16) | (Math.max(0, Math.min((int) ((d - (0.34414d * d3)) - (d2 * 0.71414d)), 255)) << 8);
            i4++;
            i2 = 0;
        }
        zzaksVar.zzc = true;
                ...
                while (i4 < i3) {
                    ...
                    if (zzm != 0) {
                        ...
                        if (zzm2 != 0) {
                            ...
                            if ((zzm2 & UserVerificationMethods.USER_VERIFY_PATTERN) == 0) {
                                i2 = this.zzb[0];
                            } else {
