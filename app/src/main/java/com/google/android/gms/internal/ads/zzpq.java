...
public final class zzpq {
    ...
    public final long zza(boolean z) {
            ...
            if (zzc - this.zzl >= 30000) {
                ...
                if (zzm != 0) {
                    ...
                    while (true) {
                        ...
                        this.zzk = (this.zzb[i2] / i3) + this.zzk;
                        i2++;
                    }
                }
            }
            if (!this.zzg) {
                ...
                if (zzpoVar.zzg(zzc)) {
                    ...
                    if (Math.abs(zzb - zzc) > 5000000) {
                        ...
                        zzpoVar.zzd();
                    } else if (Math.abs(zzei.zzt(zza, this.zzf) - zzm2) > 5000000) {
                ...
                if (this.zzp && (method = this.zzm) != null && zzc - this.zzq >= 500000) {
                    ...
                    if (audioTrack != null) {
                        int i4 = zzei.zza;
                        long intValue = (((Integer) method.invoke(audioTrack, null)).intValue() * 1000) - this.zzh;
                        this.zzn = intValue;
        ...
        if (zzf) {
            zzq = zzei.zzq(zzc2 - zzpoVar2.zzb(), this.zzi) + zzei.zzt(zzpoVar2.zza(), this.zzf);
        } else {
            if (this.zzw == 0) {
                zzq = zzm();
            } else {
        ...
        long j = zzc2 - this.zzF;
        if (j < 1000000) {
            long j2 = (j * 1000) / 1000000;
            zzq = (((1000 - j2) * (zzei.zzq(j, this.zzi) + this.zzE)) + (zzq * j2)) / 1000;
        }
        if (!this.zzj) {
            long j3 = this.zzB;
            if (zzq > j3) {
                this.zzj = true;
                int i5 = zzei.zza;
                this.zza.zzb(this.zzI.zza() - zzei.zzv(zzei.zzr(zzei.zzv(zzq - j3), this.zzi)));
            }
        }
        this.zzC = zzc2;
        this.zzB = zzq;
