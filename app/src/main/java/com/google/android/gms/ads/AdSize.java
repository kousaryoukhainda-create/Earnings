...
public final class AdSize {
    ...
    private int zzi;
    @NonNull
    public static final AdSize BANNER = new AdSize(Constants.BANNER_FALLBACK_AD_WIDTH, 50, "320x50_mb");
    @NonNull
    public static final AdSize FULL_BANNER = new AdSize(468, 60, "468x60_as");
    @NonNull
    public static final AdSize LARGE_BANNER = new AdSize(Constants.BANNER_FALLBACK_AD_WIDTH, 100, "320x100_as");
    @NonNull
    ...
    */
    public AdSize(int r5, int r6) {
        ...
        L14:
            ...
            java.lang.String r0 = defpackage.BK.m(r0, r2, r1, r3)
            r4.<init>(r5, r6, r0)
            return
        */
    ...
    public AdSize(int i, int i2, String str) {
        if (i < 0 && i != -1 && i != -3) {
            throw new IllegalArgumentException(AbstractC0324Hi.e(i, "Invalid width for AdSize: "));
        }
        if (i2 < 0 && i2 != -2 && i2 != -4) {
            throw new IllegalArgumentException(AbstractC0324Hi.e(i2, "Invalid height for AdSize: "));
        }
        this.zzb = i;
        this.zzc = i2;
        this.zzd = str;
