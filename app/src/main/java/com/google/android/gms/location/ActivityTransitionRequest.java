...
public class ActivityTransitionRequest extends AbstractSafeParcelable {
    ...
    public String toString() {
        ...
        AbstractC2437ph.w(sb, "ActivityTransitionRequest [mTransitions=", valueOf, ", mTag='", str);
        AbstractC2437ph.w(sb, "', mClients=", valueOf2, ", mAttributionTag=", str2);
        sb.append(']');
        return sb.toString();
    }
    ...
    public ActivityTransitionRequest(@NonNull @SafeParcelable.Param(id = 1) List<ActivityTransition> list, @SafeParcelable.Param(id = 2) String str, @SafeParcelable.Param(id = 3) List<ClientIdentity> list2, @SafeParcelable.Param(id = 4) String str2) {
