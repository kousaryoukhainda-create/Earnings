...
public final class zzgfn extends zzget {
    private final zzgfu zza;
    private final zzgvp zzb;
    private final zzgvo zzc;
    private final Integer zzd;

    public /* synthetic */ zzgfn(zzgfu zzgfuVar, zzgvp zzgvpVar, zzgvo zzgvoVar, Integer num, zzgfm zzgfmVar) {
        this.zza = zzgfuVar;
        this.zzb = zzgvpVar;
        this.zzc = zzgvoVar;
        this.zzd = num;
