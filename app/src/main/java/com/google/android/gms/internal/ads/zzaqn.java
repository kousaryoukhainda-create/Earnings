...
public final class zzaqn extends zzaqa {
    ...
    public final zzaqk zza(zzapm zzapmVar, Map map) throws IOException, zzaou {
        ...
        HttpConnection.DEFAULT_SCHEME.equals(url.getProtocol());
        try {
            ...
            if (zzapmVar.zza() != 0) {
                ...
                if (zzx != null) {
                    ...
                    if (!httpURLConnection.getRequestProperties().containsKey(HttpConnection.CONTENT_TYPE_HEADER)) {
                        httpURLConnection.setRequestProperty(HttpConnection.CONTENT_TYPE_HEADER, "application/x-www-form-urlencoded; charset=UTF-8");
                    }
