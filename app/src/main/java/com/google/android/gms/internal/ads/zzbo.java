...
public final class zzbo {
    ...
    public final int hashCode() {
        ...
        long j = this.zzd;
        int i3 = (((i2 * 31) + ((int) (j ^ (j >>> 32)))) * 961) + (this.zzf ? 1 : 0);
        return this.zzg.hashCode() + (i3 * 31);
    }
    ...
    public final zzbo zzi(Object obj, Object obj2, int i, long j, long j2, zzb zzbVar, boolean z) {
        this.zza = obj;
        this.zzb = obj2;
        this.zzc = i;
        this.zzd = j;
