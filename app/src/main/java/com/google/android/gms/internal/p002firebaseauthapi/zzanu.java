...
final class zzanu extends zzanv {
    ...
    */
    ...
    @Override // com.google.android.gms.internal.p002firebaseauthapi.zzanv
    public final String zza(byte[] bArr, int i, int i2) throws zzalf {
            ...
            while (i < i3) {
                ...
                if (b2 >= 0) {
                    ...
                    if (i6 < i3 - 1) {
                        int i8 = i + 2;
                        i += 3;
                        zzans.zza(b2, bArr[i6], bArr[i8], cArr, i5);
                        i5++;
                    } else {
                        throw zzalf.zzd();
                    }
                    ...
                    int i9 = i + 3;
                    i += 4;
                    zzans.zza(b2, b4, bArr[i + 2], bArr[i9], cArr, i5);
                    i5 += 2;
                } else {
                    throw zzalf.zzd();
                }
