...
public interface Spliterator<T> {
    ...
    public final /* synthetic */ class Wrapper implements java.util.Spliterator {
        ...
        public static /* synthetic */ java.util.Spliterator convert(Spliterator spliterator) {
            ...
            return spliterator instanceof O ? ((O) spliterator).a : spliterator instanceof N ? M.a((N) spliterator) : new Wrapper();
        }
        ...
        public final /* synthetic */ boolean tryAdvance(java.util.function.Consumer consumer) {
            return Spliterator.this.t(Consumer.VivifiedWrapper.convert(consumer));
        }
    ...
    boolean t(j$.util.function.Consumer consumer);
